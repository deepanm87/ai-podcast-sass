...
const FEATURES: Feature[] = [
  {
    ...
    description: "Advanced audio analysis using AssemblyAI to understand your podcast content and power all AI features."
  },
  {
    icon: FileText,
    title: "Smart Summaries",
    description: "Generate comprehensive summaries with key points and insights from your podcast content."
  },
  {
    icon: MessageSquare,
    title: "Social Posts",
    description: "Generate platform-optimized social media posts for Twitter, LinkedIn, Instagram, Tiktok, YouTube, and Facebook"
  },
  {
    icon: Hash,
    title: "Titles & Hashtags",
    description: "Get SEO-optimized titles and platform-specific hashtags automatically for maximum reach."
  },
  {
    icon: Zap,
    title: "Key Moments & Chapters",
    description: "Automatically identify viral moments and generate YouTube timestamps for better engagement"
  },
  {
    icon: Users,
