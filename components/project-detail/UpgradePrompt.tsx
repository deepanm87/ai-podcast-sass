...
export function UpgradePrompt({
  ...
  const minPlan = requiredPlan || (featureKey ? getMinimumPlanForFeature(featureKey) : "pro")
  ...
  return (
    <div className={`glass-card rounded-3xl border-2 border-dashed border-emerald-200 ${className}`}>
      <div className="text-center p-8 md:p-12">
        ...
        <div className="bg-linear-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 md:p-8 mb-8 text-left">
