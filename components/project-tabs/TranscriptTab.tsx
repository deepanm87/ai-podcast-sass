...
import { GenerateMissingCard } from "@/components/project-detail/GenerateMissingCard"
import { UpgradePrompt } from "@/components/project-detail/UpgradePrompt"
      ...
      <div className="glass-card rounded-2xl p-6 md:p-8">
        ...
        <div className="space-y-4 md:space-y-6">
          {transcript.speakers?.map(utterance => (
            ...
            >
              <Badge
                className={`mt-1 shrink-0 px-3 py-1.5 text-sm font-bold shadow-md ${getSpeakerColor(utterance.speaker)}`}
              >
