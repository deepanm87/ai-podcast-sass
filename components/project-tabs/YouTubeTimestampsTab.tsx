      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Copy these timestamps and paste them into your YouTube video description. YouTube will automatically create clickable chapter markers.
          </p>
        </div>
        <Button
          ...
          <div className="space-y-3">
            {timestamps.map(timestamp => (
              ...
              >
                ...
                <p className="text-sm md:text-base font-mono font-bold gradient-emerald text-white px-3 py-1.5 rounded-lg shadow-md shrink-0">
