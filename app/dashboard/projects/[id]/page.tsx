...
import { TabContent } from "@/components/project-detail/TabContent"
import {
  MobileTabItem,
  DesktopTabTrigger
} from "@/components/project-detail/TabTriggers"
import { ProjectStatusCard } from "@/components/ProjectStatusCard"
import { HashtagsTab } from "@/components/project-tabs/HashtagsTab"
import { KeyMomentsTab } from "@/components/project-tabs/KeyMomentsTab"
import { SocialPostsTab } from "@/components/project-tabs/SocialPostsTab"
import { SummaryTab } from "@/components/project-tabs/SummartTabs"
import { TitlesTab } from "@/components/project-tabs/TitlesTab"
import { TranscriptTab } from "@/components/project-tabs/TranscriptTab"
import { YouTubeTimestampsTab } from "@/components/project-tabs/YouTubeTimestampsTab"
          ...
          >
            <div className="glass-card rounded-2xl p-4 mb-6 lg:hidden">
              <Select value={activeTab} onValueChange={setActiveTab}>
                <SelectTrigger 
                  className="w-full px-4 py-3 rounded-xl bg-linear-to-r from-emerald-500 to-teal-400 text-white font-semibold text-base border-none outline-none focus:ring-2 focus:ring-emerald-300 transition-all h-auto">
                    <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="glass-card rounded-2xl p-2 mb-6 hidden lg:block">
              <TabsList className="flex flex-wrap gap- bg-transparent min-w-max w-full">
                {PROJECT_TABS.map(tab => (
                  <DesktopTabTrigger 
                    key={tab.value}
                    tab={tab}
